...
export const folderRemove = async (
  path: string,
  projectId: string,
  userId: mongoose.Types.ObjectId
) => {
      ...
      pushProjectHistory(
        {
          ...
          description: `Added new file "${name}" at path "${path}".`,
        },
      ...
      pushProjectHistory(
        {
          userId,
          projectId: new mongoose.Types.ObjectId(projectId),
          description: `File "${name}" at path "${path}" has been ${type === "create" ? "created" : type === "update" ? "updated" : "synchronized"}.`,
        },
        BrickHistoryTypeEnum.project
      );
      ...
      pushProjectHistory(
        {
          userId,
          projectId: new mongoose.Types.ObjectId(projectId),
          description: `Added new folder "${name}" at path "${path}".`,
        },
        BrickHistoryTypeEnum.project
      );
      socket.emit("file:add:ack", { path, name, success: !!newFile });
      ...
      pushProjectHistory(
        {
          userId,
          projectId: new mongoose.Types.ObjectId(projectId),
          description: `Removed Folder at path "${path}".`,
        },
        BrickHistoryTypeEnum.project
      );
      ...
      pushProjectHistory(
        {
          userId,
          projectId: new mongoose.Types.ObjectId(projectId),
          description: `Removed file "${name}" at path "${path}".`,
        },
        BrickHistoryTypeEnum.project
      );
      ...
      pushProjectHistory(
        {
          userId,
          projectId: new mongoose.Types.ObjectId(projectId),
          description: `Renamed file from "${oldName}" to "${name}" at path "${path}".`,
        },
        BrickHistoryTypeEnum.project
      );
